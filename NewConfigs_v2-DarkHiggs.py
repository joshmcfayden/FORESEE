...
if run_plothadrons:
    ...
    plot.savefig("NewConfigs_v2-DarkHiggs-Pythia8_Hadron-Angle_vs_Momentum.pdf")
...
if run_LLPspectra:    
    ...
    plt.savefig("NewConfigs_v2-DarkHiggs-Pythia8_LLP_m1500_t10m4-Angle_vs_Momentum.pdf")
...
if run_rateexample:    
    ...
    plt.tight_layout()
    plt.savefig("NewConfigs_v2-DarkHiggs-Pythia8_LLP_m1500-Energy.pdf")
