...
if run_plotpions:
    ...
    #plot.show()
    plot.savefig("NewConfigs_v2-DarkPhoton-EPOSLHC_Pion-Angle_vs_Momentum.pdf")
...
if run_LLPspectra:    
    ...
    #plt.show()
    plt.savefig("NewConfigs_v2-DarkPhoton-EPOSLHC_LLP_m100_e10m5-Angle_vs_Momentum.pdf")
...
if run_rateexample:    
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig("NewConfigs_v2-DarkPhoton-EPOSLHC_LLP_m100-Energy.pdf")
